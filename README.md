\# \*\*Это шпаргалка по работе с Git. Здесь представлены основные команды которые необходимы в работе.\*\*
...
\### \_\_Копирование и перемещение\_\_





* cp file.txt \~/my-dir (от англ. copy, «копировать») — скопируй файл в другое место;<bd>
